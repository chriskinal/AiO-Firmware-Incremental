...
public:
    ...
    using PGNHandler = void (*)(struct mg_connection *, int, void *);
    using RTCMHandler = void (*)(struct mg_connection *, int, void *);
...
private:
    ...
    static void pgnEventHandler(struct mg_connection *c, int ev, void *ev_data);
    static void rtcmEventHandler(struct mg_connection *c, int ev, void *ev_data);
